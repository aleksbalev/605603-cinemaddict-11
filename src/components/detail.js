...
const createCommentsMarkup = (comments) => {
  ...
  comments.forEach((item) => {
    ...
    commentsArr.push(`<li class="film-details__comment">
      ...
      <form class="film-details__inner" action="" method="get">
        <div class="form-details__top-container">
          ...
          <div class="film-details__info-wrap">
            <div class="film-details__poster">
              <img class="film-details__poster-img" src="${cardPoster}" alt="">
            ...
            <div class="film-details__info">
              <div class="film-details__info-head">
                <div class="film-details__title-wrap">
                  ...
                  <p class="film-details__title-original">Original: ${cardTitle}</p>
                </div>
        ...
        <div class="form-details__bottom-container">
          <section class="film-details__comments-wrap">
            <h3 class="film-details__comments-title">Comments <span class="film-details__comments-count">${cardComments[0]}</span></h3>
    
            <ul class="film-details__comments-list">
               ${createCommentsMarkup(cardComments[1])}
            </ul>
